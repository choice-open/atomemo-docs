...
| 通配符 `*` | `* * * * *` | 每分钟 |
| 步长 `/` | `*/15 * * * *` | 每 15 分钟 |
| 范围 `-` | `0 9-17 * * *` | 9 点到 17 点之间的每个整点 |
| 列表 `,` | `0 9,12,18 * * *` | 9:00、12:00 和 18:00 |
| 特殊 `@` | `@daily` | 每天午夜 |
...
| --- | --- |
| `0 9 * * 1` | 每周一上午 9:00 |
| `0 8,18 * * 1-5` | 每个工作日 8:00 和 18:00 |
| `*/5 * * * *` | 每 5 分钟 |
| `0 9-17 * * 1-5` | 工作日 9:00–17:00 每个整点 |
| `0 0 1,15 * *` | 每月 1 日和 15 日午夜 |
| `0 6 * * *` | 每天早上 6:00 |
| `@daily` | 每天午夜一次 |
